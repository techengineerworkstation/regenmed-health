...
$allowedPages = ['dashboard', 'conditions', 'lab-scans', 'scan-analysis', 'protocols', 'supplements', 'pemf', 'stem-cells', 'vps-providers', 'data-manager', 'case-study', 'references', 'team', 'faq', 'login', 'magic-login', 'logout'];
