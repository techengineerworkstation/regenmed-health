    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        $providers = [
            ...
            ['Me Cure Healthcare', 'Nigeria — Lagos', 'Diagnostic lab scans: MRI, PET/CT, CT, mammography, ultrasound + pathology and eye center.', 'https://www.mecure.com.ng', '+2348030868120', 'Multiple centres across Lagos, Nigeria', 'Me Cure Healthcare Lagos Nigeria'],
