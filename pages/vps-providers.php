<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8 animate-fade-in">
        ...
        <p class="text-slate-500 dark:text-slate-400 mt-2">Free and paid GPU resources for medical imaging AI training, inference, and model deployment.</p>
    ...
    <section class="bg-white dark:bg-slate-800 dark:border-slate-700/50 rounded-2xl p-8 shadow-sm border border-slate-100 dark:border-slate-700 card-border mb-8">
        <h2 class="text-xl font-bold text-slate-900 dark:text-slate-100 mb-6">Recommended Workflow for Medical Imaging ML</h2>
        ...
        <div class="space-y-4">
            ...
            $guides = [
                ...
                ['provider' => 'NVIDIA NGC (FREE — Research Grant)', 'steps' => [
                    ...
                    'Access NGC Containers for medical imaging',
